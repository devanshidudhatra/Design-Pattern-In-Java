...
class DecoratorDemo {
    public static void main(String[] args) {
        ...
        System.out.println("Cost : " + coffee.cost() + " , Description : " +
                coffee.getDescription());
        // Decorate the simple coffee with Milk
        Coffee milkCoffee = new MilkDecorator(coffee);
        System.out.println("Cost : " + milkCoffee.cost() + " , Description : " +
                milkCoffee.getDescription());
        // Decorate the simple coffee with Sugar
        Coffee sweetCoffee = new SugarDecorator(coffee);
        System.out.println("Cost : " + sweetCoffee.cost() + " , Description : " +
                sweetCoffee.getDescription());
    }
}